...
<div id="wrapper" style="width: 99%;">
    ...
    <td valign="top" colspan="3" class="bb">
		<div class="fl" style="width: 99%;">
			<h1>BigBucks Mutual Gold Visa Application</h1>
			<span><p><b>No application is needed.</b>To approve your new $10000 BigBucks Mutual Gold Visa<br />with an 7.9% APR simply enter your password below.</p>
